...
var ControlMethods = function (_React$Component5) {
  ...
  _createClass(ControlMethods, [{
    ...
    value: function componentWillMount() {
      Papa.parse("data/VegeSheet1.csv", {
        download: true,
        header: true,
        delimiter: "|",
        skipEmptyLines: true,
      ...
      return React.createElement(
        ...
        this.state.data ? React.createElement(
          ...
          React.createElement(
            'div',
            null,
			React.createElement(DropdownMult, { title: 'See legend', onChangeElem: this.onChangeElem, data: this.state.data, column: 'legend' }),
			React.createElement(DropdownMult, { title: 'Typical Use Location', onChangeElem: this.onChangeElem, data: this.state.data, column: 'location' }),
			React.createElement(DropdownMult, { title: 'Type of Installation', onChangeElem: this.onChangeElem, data: this.state.data, column: 'typeinstall' }),
			React.createElement(DropdownMult, { title: 'Initial Installation', onChangeElem: this.onChangeElem, data: this.state.data, column: 'initialinstallation' }),
			React.createElement(DropdownMult, { title: 'Life Cycle', onChangeElem: this.onChangeElem, data: this.state.data, column: 'lifecycle' }),
