...
var ControlMethods = function (_React$Component5) {
  ...
  _createClass(ControlMethods, [{
    ...
    value: function componentWillMount() {
      Papa.parse("data/VegeSheet2.csv", {
        download: true,
        header: true,
        delimiter: "|",
        skipEmptyLines: true,
      ...
      return React.createElement(
        ...
        this.state.data ? React.createElement(
          ...
          React.createElement(
			...
			React.createElement(DropdownMult, { title: 'Construction Type', onChangeElem: this.onChangeElem, data: this.state.data, column: 'construct' }),
			React.createElement(DropdownMult, { title: 'Intial Cost', onChangeElem: this.onChangeElem, data: this.state.data, column: 'icost' }),
			React.createElement(DropdownMult, { title: 'Lifecycle Cost', onChangeElem: this.onChangeElem, data: this.state.data, column: 'lcost' }),
